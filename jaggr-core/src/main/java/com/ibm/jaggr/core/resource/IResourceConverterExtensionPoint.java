...
/**
 * This interface defines constants for the {@code resourceconverter} extension
 * point
 */
public interface IResourceConverterExtensionPoint {
	/**
	 * The extension point name. This value is combined with the namespace for
	 * the extension point to form the extension point id.
	 */
	public static final String NAME = "resourceconverter"; //$NON-NLS-1$
	...
	/**
	 * List of required extension attributes for the {@code resourceconverter}
	 * extension point.
	 */
	public static final String[] REQUIRED_ATTRIBUTES = {};

	/**
	 * A reference to the {@link IResourceConverter} interface which is the
	 * interface that plugin extensions of the {@code resourceconverter} extension
	 * point must implement.
	 */
	public static final Class<?> INTERFACE = IResourceConverter.class;
